...
Future<Map<String, dynamic>?> showEditCargoModal(
  BuildContext context,
  Map<String, dynamic> cargo,
  List<UsuarioBasicInfo> usuarios,
) {
  final formKey = GlobalKey<FormState>();
  final abreviaturaController = TextEditingController(text: cargo['abreviatura']);
  final cargoNombreController = TextEditingController(text: cargo['cargo_nombre']);
  UsuarioBasicInfo? selectedUser = usuarios.firstWhere(
    (u) => u.id == cargo['id_usuario'],
